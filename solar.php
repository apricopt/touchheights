  ...
  <div class="container d-flex align-items-center">
    ...
    <nav class="nav-menu d-none d-lg-block">
      <ul>
        ...
        <li  class="drop-down "><a href="index.php#services">Services</a>
              <ul>
      ...
      <section id="breadcrumbs" class="breadcrumbs" data-aos="fade-up">
        <div class="container">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h2>Solar Consultant</h2>
            <ol>
              <li><a href="index.php#services">Services</a></li>
              <li>Solar Consultant</li>
            </ol>
          </div>
        ...
        <div class="container">
          ...
          <div class="portfolio-details-container">
            ...
            <div class="owl-carousel portfolio-details-carousel">
              <img src="assets/img/solarhouse.jpg" class="img-fluid" alt="">
            ...
            <section class="text-center px-md-5 mx-md-5 dark-grey-text">
              ...
              <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-7">
                  ...
                  <p>TH come up with high quality, hassle free solar installations at the lowest cost and with the highest reliability. We aim to improve energy solutions by increasing quality and reducing energy costs.</p>

                  <p>TH is providing solar consultation for you to choose best solar options and see the drastic reduction in your monthly electricity bills. You can get independent solar electric power that can mostly balance or completely eliminate your electric bill. Our vision is to provide eco-friendly environment to every home and the access to clean energy by eliminating all barriers. </p>
...
<div class="container py-4">
  ...
  <script src="assets/js/main.js"></script>
   ...
   <script src="assets/js/appService.js"></script>
